...
if clientID!=-1:
    ...
    vrep.simxSetFloatSignal(clientID,"p1",9.1,vrep.simx_opmode_blocking)
    vrep.simxSetFloatSignal(clientID,"p2",9.8,vrep.simx_opmode_blocking)
    vrep.simxSetFloatSignal(clientID,"p3",9.47,vrep.simx_opmode_blocking)
    vrep.simxSetFloatSignal(clientID,"p4",8.66,vrep.simx_opmode_blocking)
