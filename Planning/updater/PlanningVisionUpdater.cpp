...
void PlanningVisionUpdater::update() {
    ...
    while (true) {
        ...
        simxSetFloatSignal(clientID, "target_x", p.x(), simx_opmode_blocking);
        simxSetFloatSignal(clientID, "target_y", p.y(), simx_opmode_blocking);
        simxSetFloatSignal(clientID, "target_z", p.z(), simx_opmode_blocking);
        ...
        simxSetFloatSignal(clientID, "circle_x", p.x(), simx_opmode_blocking);
        simxSetFloatSignal(clientID, "circle_y", p.y(), simx_opmode_blocking);
        simxSetFloatSignal(clientID, "circle_z", p.z(), simx_opmode_blocking);
